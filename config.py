...
train_arg.add_argument('--d_lr', type=float, default=0.00009)
train_arg.add_argument('--g_lr', type=float, default=0.00009)
...
misc_arg.add_argument('--save_step', type=int, default=50)
